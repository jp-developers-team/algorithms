# Algorítmo...
# Calculando o valor de uma área e do perímetro
# será informado o valor do lado de um quadrado e logo apóe, será calculado o valor da área e o valor do perímetro
# Objetivo é calcular uma expressão muito usada no dia a dia de muitos, [Lado, Área e Perímetro], além, do [while] que é uma estrutura de repetição
